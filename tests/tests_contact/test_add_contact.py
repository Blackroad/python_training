...
def test_add_contact(app):
    ...
    contact = Contacts(first_name='ADt',last_name='vadddda',nickname='fsse',home_phone='Home[123441]',
                       ...
                       email='email144@gmail.com',email2='email123@gmail.com',email3='email3@yandex.ru')
